...
# machine learning methods. This version allows for missing outcomes. 
...
cond_comp_mis <- function(datause, dataout, y, d, r, rt, rc, x, method, plinear, 
  ...
  if(method=="Boosting")
  {
    ...
    if(plinear==0){
      ...
      fit.yz1 <- xg.boost(datause=datause[ind_u_rt,], dataout=dataout, 
      ...
      fit.yz0 <- xg.boost(datause=datause[ind_u_rc,], dataout=dataout, 
    ...
    fit.rt    <- xg.boost(datause=datause, dataout=dataout, form_x=form_x, 
                          form_y=rt, nround=arg$nrounds.rt, eta=arg$eta.rt, 
                          max.depth=arg$max_depth.rt, 
                          subsample=arg$subsample.rt, 
                          colsample_bytree=arg$colsample_bytree.rt, 
                          min_child_weight=arg$min_child_weight.rt, 
                          binary=binary.d)
    fit.rc    <- xg.boost(datause=datause, dataout=dataout, form_x=form_x, 
                          form_y=rc, nround=arg$nrounds.rc, eta=arg$eta.rc,
                          max.depth=arg$max_depth.rc, 
                          subsample=arg$subsample.rc, 
                          colsample_bytree=arg$colsample_bytree.rc, 
                          min_child_weight=arg$min_child_weight.rc, 
                          binary=binary.d)
    
    fit.r_t   <- xg.boost(datause=datause[ind_u,], dataout=dataout, 
                          form_x=form_x, form_y=rt, nround=arg$nrounds.r_t, 
                          eta=arg$eta.r_t, max.depth=arg$max_depth.r_t, 
                          subsample=arg$subsample.r_t, 
                          colsample_bytree=arg$colsample_bytree.r_t, 
                          min_child_weight=arg$min_child_weight.r_t, 
                          binary=binary.d)
    fit.r_c   <- xg.boost(datause=datause[-ind_u,], dataout=dataout, 
                          form_x=form_x, form_y=rc, nround=arg$nrounds.r_c, 
                          eta=arg$eta.r_c, max.depth=arg$max_depth.r_c, 
                          subsample=arg$subsample.r_c, 
                          colsample_bytree=arg$colsample_bytree.r_c, 
                          min_child_weight=arg$min_child_weight.r_c, 
                          binary=binary.d)
  ...
  if(method=="RLasso" || method=="PostRLasso"){
    ...
    if(plinear==0){
      ...
      fit.yz1 <- rlassoF(datause=datause[ind_u,], dataout=dataout, form_x, 
                         form_y, post, logit=logit.y, 
                         arg=arg)[c("yhatout", "model")]
      err.yz1 <- error(fit.yz1$yhatout[ind_o,], dataout[ind_o,y])$err
      my_z1x  <- fit.yz1$yhatout
      
      fit.yz0 <- rlassoF(datause=datause[-ind_u,], dataout=dataout, form_x, 
                         form_y, post, logit=logit.y, 
                         arg=arg)[c("yhatout", "model")]
      err.yz0 <- error(fit.yz0$yhatout[-ind_o,], dataout[-ind_o,y])$err
      my_z0x  <- fit.yz0$yhatout
    ...
    if(binary.d==1){
      fit.z   <- rlassoF(datause=datause, dataout=dataout, form_x, form_d, post, 
                         logit=TRUE, arg=arg)[c("yhatout", "resout")]
      mis.z   <- error(fit.z$yhatout, dataout[,d])$mis
    }
  ...
  if(method=="Ridge" || method=="Lasso" || method=="Elnet" || 
    ...
    if(plinear==0){
      ...
      alp <- arg$alpha.yd1
      fit.yz1 <- RegRegF(datause=datause[ind_u_rt,], dataout=dataout, form_x, 
      ...
      alp <- arg$alpha.yd0
      fit.yz0 <- RegRegF(datause=datause[ind_u_rc,], dataout=dataout, form_x, 
                         form_y, logit=logit.y, lambda=lambda, alp=alp, 
                         post=post)
      err.yz0 <- error(fit.yz0$yhatout[ind_o_rc], dataout[ind_o_rc,y])$err
      my_z0x  <- fit.yz0$yhatout
    ...
    fit.rt    <- RegRegF(datause=datause, dataout=dataout, form_x, rt, 
                         logit=TRUE, lambda=arg$lambda.rt, alp=arg$alpha.rt, 
                         post=post)
    fit.rc    <- RegRegF(datause=datause, dataout=dataout, form_x, rc, 
                         logit=TRUE, lambda=arg$lambda.rc, alp=arg$alpha.rc, 
                         post=post)
    
    fit.r_t   <- RegRegF(datause=datause[ind_u,], dataout=dataout, form_x, rt, 
                         logit=TRUE, lambda=arg$lambda.r_t, alp=arg$alpha.r_t, 
                         post=post)
    fit.r_c   <- RegRegF(datause=datause[-ind_u,], dataout=dataout, form_x, rc, 
                         logit=TRUE, lambda=arg$lambda.r_c, alp=arg$alpha.r_c, 
                         post=post)
  ...
  if(method=="CLasso"){
    ...
    lambda <- arg$lambda.yd1
    alpha <- arg$alpha.yd1
    fit.yz1 <- RegRegF(datause=datause[ind_u_rt,], dataout=dataout, form_x.yz1, 
    ...
    lambda <- arg$lambda.yd0
    alpha <- arg$alpha.yd0
    fit.yz0 <- RegRegF(datause=datause[ind_u_rc,], dataout=dataout, form_x.yz0, 
                       form_y, logit=logit.y, lambda=lambda, alp=1, post=FALSE)
    err.yz0 <- error(fit.yz0$yhatout[ind_o_rc], dataout[ind_o_rc,y])$err
    my_z0x  <- fit.yz0$yhatout
    ...
    alpha <- arg$alpha.rt
    fit.rt  <- RegRegF(datause=datause, dataout=dataout, form_x.rt, rt, 
                       logit=logit.d, lambda=lambda, alp=1, post=FALSE)
    mis.rt  <- NA
    
    lambda <- arg$lambda.rc
    alpha <- arg$alpha.rc
    fit.rc  <- RegRegF(datause=datause, dataout=dataout, form_x.rc, rc, 
                       logit=logit.d, lambda=lambda, alp=1, post=FALSE)
    mis.rc  <- NA
    
    lambda <- arg$lambda.r_t
    alpha <- arg$alpha.r_t
    fit.r_t <- RegRegF(datause=datause[ind_u,], dataout=dataout, form_x.r_t, rt, 
                       logit=TRUE, lambda=lambda, alp=1, post=FALSE)
    mis.r_t <- NA
    
    lambda <- arg$lambda.r_c
    alpha <- arg$alpha.r_c
    fit.r_c <- RegRegF(datause=datause[-ind_u,], dataout=dataout, 
                       form_x.r_c, rc, logit=TRUE, lambda=lambda, alp=1, 
                       post=FALSE)
    mis.r_c <- NA
  ...
  if(method=="Forest" | method=="TForest"){
    ...
    if(plinear==0){
      ...
      fit.yz1 <- RF(datause=datause[ind_u_rt,], dataout=dataout, form_x=form_x, 
      ...
      fit.yz0 <- RF(datause=datause[ind_u_rc,], dataout=dataout, form_x=form_x, 
                    form_y=form_y, nodesize=nodesize.y, arg=arg, reg=reg.y, 
                    tune=tune)
    ...
    fit.rt    <- RF(datause=datause, dataout=dataout, form_x=form_x, form_y=rt, 
                    nodesize=nodesize.y, arg=arg, reg=FALSE, tune=tune)
    fit.rc    <- RF(datause=datause, dataout=dataout, form_x=form_x, form_y=rc, 
                    nodesize=nodesize.y, arg=arg, reg=FALSE, tune=tune)
    
    fit.r_t   <- RF(datause=datause[ind_u,], dataout=dataout, form_x=form_x,
                    form_y=rt, nodesize=nodesize.y, arg=arg, reg=FALSE, 
                    tune=tune)
    fit.r_c   <- RF(datause=datause[-ind_u,], dataout=dataout, form_x=form_x,  
                    form_y=rc, nodesize=nodesize.y, arg=arg, reg=FALSE, 
                    tune=tune)
  ...
  if(method=="SVM"){
    ...
    if(plinear==0){
      ...
      fit.yz1 <- svmF(datause[ind_u_rt,], dataout, form_x, form_y, 
                      cost=arg$cost_hsd1, gamma=arg$gamma_hsd1, binary=binary.y)
      err.yz1 <- error(fit.yz1$yhatout[ind_o_rt], dataout[ind_o_rt,y])$err
      my_z1x  <- fit.yz1$yhatout

      fit.yz0 <- svmF(datause[ind_u_rc,], dataout, form_x, form_y, 
                      cost=arg$cost_hsd0, gamma=arg$gamma_hsd0, binary=binary.y)
      err.yz0 <- error(fit.yz0$yhatout[ind_o_rc], dataout[ind_o_rc,y])$err
      my_z0x  <- fit.yz0$yhatout
    }
    ...
    fit.rt    <- svmF(datause, dataout, form_x, rt, cost=arg$cost_rt, 
                      arg$gamma_rt, binary=1)
    fit.rc    <- svmF(datause, dataout, form_x, rc, cost=arg$cost_rc, 
                      arg$gamma_rc, binary=1)
    
    fit.r_t   <- svmF(datause[ind_u,], dataout, form_x, rt, cost=arg$cost_rt, 
                      arg$gamma_rt, binary=1)
    fit.r_c   <- svmF(datause[-ind_u,], dataout, form_x, rc, cost=arg$cost_rc, 
                      arg$gamma_rc, binary=1)
  ...
  return(list(my_z1x = my_z1x, mz_x = mz_x, my_z0x = my_z0x, err.z = err.z, 
              ...
              fit.yz1out = fit.yz1$yhatout[ind_o_rt], 
              fit.yz0out = fit.yz0$yhatout[ind_o_rc], err.rt = err.rt, 
              m_rt = m_rt, err.rc = err.rc, m_rc = m_rc, err.r_t = err.r_t, 
              m_r_t = m_r_t, err.r_c = err.r_c, m_r_c = m_r_c, 
              fit.r_tout = fit.r_t$yhatout[ind_o], 
              fit.r_cout = fit.r_c$yhatout[-ind_o]));
