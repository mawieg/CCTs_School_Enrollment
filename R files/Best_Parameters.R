...
# the respective method for the model without attrition. 
...
Best_Parameters <- function(method, data, y, d, groupvar, xvars, folds, reps, 
                            seed = 1){
  ...
  if(method == "SVM") {
    ...
    svm.tune.d0 <- 
      train(form = form, data = data.y, method = "svmRadial", metric = "ROC", 
